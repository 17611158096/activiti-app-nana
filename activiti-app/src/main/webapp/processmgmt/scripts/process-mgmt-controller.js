 ...
 */
activitiApp.controller('ProcessMgmtController', ['$rootScope', '$scope', '$translate', '$http', '$timeout', '$location', '$modal',
    function ($rootScope, $scope, $translate, $http, $timeout, $location, $modal) {
        ...
        $rootScope.setMainPageById('processMgmt');
        ...
        $scope.loadUsers = function () {
            ...
            $http({
                method: 'GET',
                url: ACTIVITI.CONFIG.contextRoot + '/app/rest/processmgmt/process',
                //params: params
            }).success(function (data, status, headers, config) {
                data.moreUsers = data.start + data.size < data.total;
